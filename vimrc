...
" If we have termguicolors set, then we'll need to touch some things up.
"
" These were checked/tested on zenburn

fun! s:TermGuiColors()

    " note that the gui colors appear to apply when termguicolors is set, but
    " 'gui=' is ignored in favor of 'cterm='

    hi SignifySignAdd    term=NONE cterm=NONE ctermfg=66 gui=NONE guibg=Black guifg=LightGreen
    hi SignifySignDelete term=NONE cterm=NONE ctermfg=66 gui=NONE guibg=Black guifg=LightRed
    hi SignifySignChange term=NONE cterm=NONE ctermfg=66 gui=NONE guibg=Black guifg=Orange

    " hi Normal                            cterm=underline ctermbg=none
    " hi SignColumn                        cterm=underline ctermbg=none
    " hi LineNr                            cterm=underline guibg=Black
...
augroup vimrc#colorscheme
    ...
    au ColorScheme zenburn :call s:TermGuiColors()

    " au ColorScheme zenburnZZZ
    "     \ hi Normal                            ctermbg=none             |
    "     \ hi SignColumn                        ctermbg=none             |
    "     \ hi LineNr                            ctermbg=none             |
    "     \ highlight DiffAdd         cterm=bold ctermbg=none ctermfg=119 |
