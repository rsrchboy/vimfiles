...
call s:tools.nnore2map('S',  ":execute 'Gcommit --no-verify --squash='.gv#sha()<CR>:close<CR>:GV<CR>")

call s:tools.nnore2map('C', ":Gcommit<CR>")

call s:tools.nnoremap('R', ":execute 'Git revert --no-edit '        .gv#sha()<CR>:close<CR>:GV<CR>")
